...
const Header = () => {
  ...
  const getProfile = async () => {
    let result = await fetch(
      `${process.env.REACT_APP_BACKEND_ORIGIN}/get_profile`,
      {
        method: "POST",
        credentials: "include",
      }
    ...
    <div className="header">
      <div className="wrapper">
        <div className="items">
          ...
          <div
            className="item item_responsive"
            title="Full screen"
            onClick={() => {
              ...
              >
                ...
                >
                  {userImage === null ? (
                    ...
                    <img
                      src={`${process.env.REACT_APP_BACKEND_ORIGIN}/profile_images/${userImage}`}
                      alt=""
                      style={{
                        width: "60px",
                        height: "60px",
                  ...
                  <div
                    style={{ fontSize: "normal", textTransform: "uppercase" }}
                  >
                    {userName}
                  </div>
